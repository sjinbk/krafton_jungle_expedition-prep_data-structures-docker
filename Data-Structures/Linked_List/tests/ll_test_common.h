...
#include <signal.h>
#include <unistd.h>
#define LL_TEST_TIMEOUT_ENABLED 1
#else
#define LL_TEST_TIMEOUT_ENABLED 0
#endif

static int g_test_count = 0;
static int g_fail_count = 0;

#define LL_TEST_TIMEOUT_SECONDS 2
#define LL_MAX_LIST_NODES_TO_CHECK 2048
...
static void print_list_safely(LinkedList *ll)
{
	...
	if (limit < 0 || limit > LL_MAX_LIST_NODES_TO_CHECK) {
		limit = LL_MAX_LIST_NODES_TO_CHECK;
	}
